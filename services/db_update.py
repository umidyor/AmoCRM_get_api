...
#
# duplicates = (
#     Leads_status.objects.values('lead_id')
...
# duplicates_to_delete = Leads_status.objects.exclude(id__in=ids_to_retain)
#
# # Delete duplicates
...
Leads_status.objects.exclude(last_time_sync=specific_time).delete()
