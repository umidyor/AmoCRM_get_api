...
class Lead(models.Model):
    ...
    lead_place=models.CharField(max_length=255,null=True)
    lead_istochnik=models.CharField(max_length=255,null=True)
    etiroz_sababi=models.CharField(max_length=255,null=True)
